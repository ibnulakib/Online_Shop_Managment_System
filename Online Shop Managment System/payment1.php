								...
								<div class="col-md-8">
									<div class="panel panel-default">
										...
										<div class="panel-body">
											...
											<a href="logout.php" class="btn btn-success btn-lg">Continue Shopping</a>
											<span style="float:right;" ><a href="customer_invoice.php?id=<?php echo $_SESSION["uid"];?>" class="btn btn-success btn-lg">View Invoice</a> </span>
										</div>
